...
class DiscountCode(Base):
    ...
    usage_history = relationship("DiscountCodeUsage", back_populates="discount_code", cascade="all, delete-orphan")
...
class DiscountCodeUsage(Base):
    ...
    # Relationships
    discount_code = relationship("DiscountCode", back_populates="usage_history")
    user = relationship("User", back_populates="discount_code_usages")
    payment = relationship("Payment", back_populates="discount_usage")
...
class Refund(Base):
    ...
    processor = relationship("User", back_populates="processed_refunds")
